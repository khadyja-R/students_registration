                    ...
                    <div class="product border-bottom table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                   ...
                                   <img src="<?php echo  $_SESSION['personal_picture']; ?> ">

                                <tr>
                                    <td>
                                        <div class="product-qty"> <span class="d-block text-muted">Nom: <?php echo $_SESSION['first_name'];?></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <div class="product-qty"> <span class="d-block text-muted">Pérnom: <?php echo $_SESSION['last_name'];?></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-qty"> <span class="d-block text-muted">Téléphone: <?php echo $_SESSION['phone'];?></span></div>
                                    </td>
                                </tr>
                            <div class="col-md-6">
                                <tr >
                                    <td>
                                        <div class="product-qty"> <span class="d-block text-muted">Date de naissence: <?php echo $_SESSION['phone'];?></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="product-qty"> <span class="d-block text-muted">Code Massare: <?php echo $_SESSION['cne'];?></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-qty"> <span class="d-block text-muted">Année Bac: <?php echo $_SESSION['bac_year'];?> <span></span></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>

...
$(document).ready(function () {
        ...
        if ($.trim($('#cne').val()).length === 0) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (error_first_name!='' || error_last_name!='' || error_phone!=''||error_email!=''|| error_cne!=''||error_birthday!='' ||error_password!='' || error_confirm_password!=''||error_gender!=''||error_situation!=''
                   ||error_nationaity!=''||error_adress!='') {
                        swal({
    ...
    $('#step2btn').click(function () {
        ...
        if (error_school_year != '' || error_bac_type != '' || error_sector != '' || error_recto != '' || error_verso != '' || error_personal_picture != '' || error_note != ''||error_cin!='') {
            swal({
                title: " oopss...you are messing some thing!",
                text: "",
                icon: "error",
